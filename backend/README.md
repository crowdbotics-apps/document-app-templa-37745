...
## Project Structure
    ...
    ├── document_app_templa_37745  # Django project configurations
...
1. Clone this repo and `cd document_app_templa_37745`
...
2. Clone this repo and `cd document_app_templa_37745`
